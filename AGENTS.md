...
├── decor.html          # 家宅图鉴公开壳（任务书 #51 WP2，免登录可分享，只引用三件套零内嵌）
├── css/
...
│   ├── decorData.js    # 家宅图鉴数据层+渲染层（双壳单一真源 window.DecorCatalog；decor.html 公开壳已随 WP2 落地）
